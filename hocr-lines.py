...
# this code is for parsing te file which is accepted from cmd
...
doc = html.parse("D:/Jyoti-backup/PyCharmProjects/Info-Extraction/output.hocr")

for line in doc.xpath("//*[@class='ocr_par']"):
