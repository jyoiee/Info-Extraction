...
def explode_search_term(search_term):
    STEM_MAP = generate_stem_map(["possiblities","changing","changed","possibility","bicycling","comprehensively","obiviously"])
...
exploded_terms = explode_search_term("obiviously")
